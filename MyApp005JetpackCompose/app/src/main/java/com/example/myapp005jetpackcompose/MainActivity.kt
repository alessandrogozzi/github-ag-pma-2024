...
fun ComposeExample() {
    ...
    */
    ...
    var barva by remember { mutableStateOf("") }
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                label = { Text("Oblíbené číslo do 10.)") },
                modifier = Modifier.fillMaxWidth()
            )
            ...
            Row(
                ...
                Button(
                    onClick = {
                        resultText = "Jmenuji se $name $surname. Je mi $age let a moje bydliště je $place. Moje oblíbená barva je $barva a číslo $cislo."
                    },
